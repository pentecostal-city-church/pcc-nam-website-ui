...
const MapChart = _ref => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_simple_maps__WEBPACK_IMPORTED_MODULE_1__.ComposableMap, {
    ...
    return geographies.map(geo => {
      ...
      return cur !== null && cur !== void 0 && cur.id ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_simple_maps__WEBPACK_IMPORTED_MODULE_1__.Geography, {
        key: geo.rsmKey,
        geography: geo,
        onMouseEnter: () => {
          setTooltipContent({
            id: cur.id,
            label: (cur ? cur.name : null) + " \u2014 " + (cur ? cur.unemployment_rate : null)
          });
        },
        onMouseLeave: () => {
          setTooltipContent({
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "23c9182c8d389be26016"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=cms.44730c894578a4d93166.hot-update.js.map