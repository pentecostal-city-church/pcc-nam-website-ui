  ...
  return (
    <div>
        <div style={{ marginTop: '0px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ margin: '0px', backgroundPositionX: '50%', backgroundPositionY: '50%', backgroundRepeat: 'no-repeat', backgroundAttachment: 'scroll', backgroundPosition: 'center', backgroundBlendMode: 'soft-light', backgroundColor: 'rgba(60,52,47,1)', backgroundSize: 'cover', height: '630px', width: '100%', backgroundImage: 'url("https://s3.amazonaws.com/media.cloversites.com/d9/d9509a98-d2b2-40ff-8581-57203fc30f00/gallery/slides/mobile_6eb558c6-4997-4125-8dbc-b1581041608d.jpeg")' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', marginTop: '98.5px' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '48px', marginBottom: '0px' }}>
          <p style={{ margin: '0px 24px', fontSize: '14px' }}>{`Below is a list of the various ministries that fall under the umbrella of our District North American Missions Department.`}</p>
        </div>
        <div className={'ministry-container-margin'}>
            <div className="ministry-container">
                ...
                <div className="ministry-text-container">
                    ...
                    <div>
                        <p style={{ margin: '0px', color: 'white', fontSize: '14px' }}>SoCal North American Missions produces and oversees one of the District’s most vital ministries: PK Retreat. This wonderful ministry provides a unique opportunity for the children of licensed ministers to receive spiritual mentorship in a curated environment designed just for them. We are privileged to contribute to the development of future leaders in our movement and approach this ministry with the utmost dedication. If you would like to support this ministry, please click <a style={{ margin: '0px', fontSize: '16px', color: 'rgb(30, 150, 168)' }} href={`/give`} >here</a> to make an offering and select 'PK Retreat' from the dropdown list.</p>
                    </div>
                </div>
            </div>
        </div>

        <div style={{ marginTop: '80px' }} className={'ministry-container-margin'}>
            <div className="ministry-container">
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div style={{ marginTop: '36px' }}>
