        ...
        <div style={{ marginTop: '98.5px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', margin: '0px', width: '80%' }}>
                <div style={{ marginTop: '20px', width: '80%', maxWidth: '512px', alignSelf: 'flex-start' }}>
                    ...
                    <div style={{ marginBottom: '24px' }}>
                        <div>
                            <p style={{ color: 'rgb(177, 177, 177)', color: 'white', fontFamily: 'sans-serif', marginBottom: '4px', fontSize: '22px', fontWeight: 300 }}>
                                Phone Number
                            </p>
                        </div>
                    ...
                    <div style={{ marginBottom: '24px' }}>
                        <div><p style={{ color: 'rgb(177, 177, 177)', fontFamily: 'sans-serif', marginBottom: '4px', fontSize: '22px', fontWeight: 300 }}>Email</p></div>
                    ...
                    <div>
                        <div><p style={{ color: 'rgb(177, 177, 177)', fontFamily: 'sans-serif', marginBottom: '4px', fontSize: '22px', fontWeight: 300 }}>How can we help you today?</p></div>
                        <div><input value={reason} onChange={(e) => setReason(e.target.value)} style={{ color: 'white', padding: '0px 16px', border: '2px solid #fff', width: '100%', backgroundColor: 'black', maxWidth: '512px', height: '60px' }} /></div>
                    </div>
                </div>
            </div>
